const CACHE_NAME = 'wreck-surveyor-v1.0';
const CACHE_URLS = [
  './',
  './index.html',
  './manifest.json',
  ...
  'https://cdn.jsdelivr.net/npm/three@0.177.0/examples/jsm/lines/Line2.js',
  'https://cdn.jsdelivr.net/npm/three@0.177.0/examples/jsm/lines/LineMaterial.js',
  'https://cdn.jsdelivr.net/npm/three@0.177.0/examples/jsm/lines/LineGeometry.js'
];
